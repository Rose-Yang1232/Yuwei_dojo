...
This application is vulnerable to a _Command injection_.
This means that you can inject linux terminal commands to be run by the application if you are clever!
